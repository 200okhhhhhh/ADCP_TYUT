function scoregraph() {
  ...
  if (self)
    $.get(
      script_root + "/api/v1/teams/" + team_account_id + "/solves",
      function(solve_data) {
        $.get(
          script_root + "/api/v1/teams/" + team_account_id + "/awards",
          function(award_data) {
...
function category_breakdown_graph() {
  ...
  $.get(script_root + "/api/v1/teams/" + team_account_id + "/solves", function(
    response
  ) {
